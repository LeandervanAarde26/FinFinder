import { style, transition, trigger, query, group, animate, animateChild } from '@angular/animations';
        ...
        transition('* <=> *', [
            ...
            group([
                query(':leave', [
                    ...
                    animate('400ms ease-in', style({ transform: 'translateY(100%)', opacity: 1 }))
                ]),
                query(':enter', [
