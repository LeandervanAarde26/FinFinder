...
export class LocationModel{
   ...
   public remainingSpace: number;
    ...
    constructor(id: string, tankSize: number, locationName: string, address: string,occuppied: UserFishInterFace[], decor:  DecorationsInterface[], utilities: UtilitiesInterface[], remainingSpace: number){
        this.id = id;
