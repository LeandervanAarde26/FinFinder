...
export class HeaderComponent implements OnInit, OnDestroy {
  headerContent: Content[] = [
    new Content("Fin Finder", "Are you tired of feeling like a fish out of water when it comes to managing your fishing tanks? Say goodbye to boring and hello to Finfinder - the ultimate inventory management system for all you fishing enthusiasts out there!"),
