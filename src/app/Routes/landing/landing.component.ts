...
export class LandingComponent {
  serviceContent: serviceCard[] = [
    new serviceCard(
      '../../../assets/malawi.png',
      'View Fishtanks',
      "Viewing and managing fishtanks has never been so easy! Keep track of where your tanks are and which scaly friends you have living inside of them! It's just never been this easy!"
    ),
    new serviceCard(
      '../../../assets/Beta.png',
      'Create Fishtanks',
